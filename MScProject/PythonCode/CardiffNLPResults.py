...
finalResultsList = [
    ["1 - 99 Characters", len(outputData_0_100), f"{Accuracy_0_100} %", f"{Weighted_precision_0_100} %", f"{Weighted_recall_0_100} %", f"{Weighted_F1_0_100} %", f"{Unweighted_precision_0_100} %", f"{Unweighted_recall_0_100} %", f"{Unweighted_F1_0_100} %"],
